...
public:
	...
	static bool _bson_extract_child_response(bson_t *b, FString key, ROSMessages::auto_scene_gen_msgs::WorkerIssueNotificationResponse *response, bool LogOnErrors = true)
	{
		bool KeyFound = false;
	...
	static void _bson_append_response(bson_t *b, const ROSMessages::auto_scene_gen_msgs::WorkerIssueNotificationResponse *response)
	{
