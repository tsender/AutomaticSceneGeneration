...
{
	*Response = MakeShareable(new ROSMessages::auto_scene_gen_msgs::FRunScenarioResponse);
...
{
    return MakeShareable(new ROSMessages::auto_scene_gen_msgs::FRunScenarioResponse);
}
