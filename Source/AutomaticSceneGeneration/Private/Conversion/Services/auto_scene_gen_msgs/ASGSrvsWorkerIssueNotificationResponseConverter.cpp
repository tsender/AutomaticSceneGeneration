...
{
	*Response = MakeShareable(new ROSMessages::auto_scene_gen_msgs::FWorkerIssueNotificationResponse);
...
{
    return MakeShareable(new ROSMessages::auto_scene_gen_msgs::FWorkerIssueNotificationResponse);
}
