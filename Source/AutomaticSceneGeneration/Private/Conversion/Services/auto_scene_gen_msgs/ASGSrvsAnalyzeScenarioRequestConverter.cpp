...
{
    auto CastRequest = StaticCastSharedPtr<ROSMessages::auto_scene_gen_msgs::FAnalyzeScenarioRequest>(Request);
...
{
    return MakeShareable(new ROSMessages::auto_scene_gen_msgs::FAnalyzeScenarioRequest);
}
